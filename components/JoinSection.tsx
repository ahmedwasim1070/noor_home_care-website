...
function JoinSection() {
    ...
    return (
        <section className="max-w-7xl mx-auto px-6" aria-label="Explore careers at home care">
            <div className="rounded-lg border border-primary/20 shadow-2xl overflow-hidden relative">
                ...
                <div className="relative p-6 md:p-12 lg:p-16 mb-3">
                    ...
                    <Link href={'/careers'} aria-label="Explore careers at Noor Home Care" className="bg-light-secondary hover:bg-secondary/90 text-primary font-bold text-base md:text-lg px-6 md:px-8 py-4 md:py-4 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                        Explore Careers
                    </Link>
                </div>
            </div>
